...
class NDSolve:
    def __init__(self, f, U0, domain, max_iter=10, eps_iter=1e-7, rtol=1e-4, atol=1e-6, first_step='Default', min_step='Default', max_step='Default'):
        self.method = 'Not chosen yet.'
        self.solver_methods = {
            'euler': self.ForwardEuler,
            'eulercromer': self.EulerCromer,
            'leapfrog': self.Leapfrog,
            'heun': self.Heun,
            'rk2': self.RK2,
            'rk3': self.RK3,
            'rk4': self.RK4,
            'adamsbashforth2': self.AdamsBashforth2,
            'adamsbashforth3': self.AdamsBashforth3,
            'adamsbashforth4': self.AdamsBashforth4,
            'adamsbashmoulton2': self.AdamsBashMoulton2,
            'adamsbashmoulton3': self.AdamsBashMoulton3,
            'staggeredmidpoint': self.StaggeredMidpoint,
            'midpointiter': self.MidpointIter,
            'rkfehlberg': self.RKFehlberg}
    ...
    def solve(self, method='eulercromer'):
        self.method = method
        self.step = self.solver_methods[self.method]
